...
function Footer() {
  ...
  const links = [
    ...
    {
      title: "github",
      href: "https://github.com/Muhammad-Waleed-Khalil",
    },
    {
      title: "linkedIn",
      href: "https://www.linkedin.com/in/mwaleedkhalil/",
    },
    {
      title: "phone",
      href: "tel:+923199648331",
    },
  ];

  const line1 = "Let's build something";
  const line2 = "impactful together.";
  const line3 = "Ready to collaborate?";

  const downloadCV = () => {
    const link = document.createElement("a");
    link.href = "/mwaleedkhalil-resume.pdf";
    link.download = "Muhammad_Waleed_Khalil_CV.pdf";
    link.click();
  };
      ...
      <div className="flex flex-col-reverse md:flex-row md:justify-between gap-y-6">
        <ul className="flex-1 flex flex-row justify-between md:justify-normal md:flex-col md:gap-y-1">
          ...
          <motion.li
            ...
            className="relative w-fit text-[14px] md:text-[18px] capitalize after:duration-300 after:ease hover:after:w-full after:absolute after:w-0 after:h-[2px] after:top-full after:left-0 after:bg-lightText after:dark:bg-darkText cursor-pointer"
            onClick={downloadCV}
          >
            download CV
          </motion.li>
